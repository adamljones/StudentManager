  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved instructor as @instructor" do
        ...
        post :create, {:instructor => { "firstname" => "invalid value" }}, valid_session
        assigns(:instructor).should be_a_new(Instructor)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested instructor" do
        ...
        Instructor.any_instance.should_receive(:update).with({ "firstname" => "MyString" })
        put :update, {:id => instructor.to_param, :instructor => { "firstname" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the instructor as @instructor" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Instructor.any_instance.stub(:save).and_return(false)
        put :update, {:id => instructor.to_param, :instructor => { "firstname" => "invalid value" }}, valid_session
        assigns(:instructor).should eq(instructor)
      end
